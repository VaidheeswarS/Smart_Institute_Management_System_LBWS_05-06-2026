    ...
    if($data['token']==$_SESSION['csrf_token']){
        ...
        if($result['user_status']==1){
            ...
            try {
                ...
                echo json_encode([
                    "success"=>true,
                    "message"=>"Deactivated Staff, error on sending email to staff."
                ]);
                exit();
            }
            ...
            echo json_encode([
                "success"=>true,
                "message"=>"Deactivated Staff, email sent to staff."
            ]);
            exit();
        }
        else{
            ...
            try {
                ...
                echo json_encode([
                    "success"=>true,
                    "message"=>"Activated Staff, error on sending email to staff."
                ]);
                exit();
            }
            echo json_encode([
                "success"=>true,
                "message"=>"Activated Staff, email sent to staff."
