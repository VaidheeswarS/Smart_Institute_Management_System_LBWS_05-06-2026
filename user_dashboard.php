...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/individual_course.css">    
        ...
        <style>
            *{
            ...
            .student-page #navbar-div li:hover{
            ...
            .student-page #activity-bar ul{
                list-style: none;
                padding-top: 20px;
            }

            .student-page #activity-bar li{
                padding: 15px 20px;
                cursor: pointer;
                font-weight: 500;
                color: #333;
            ...
            .student-page #activity-bar li:hover{
                background-color: rgb(28,122,173);
                color: white;
            }
    ...
    <body class="student-page">
        ...
        <script src="assets/scripts/user_dashboard.js">
        ...
        <script src="assets/scripts/individual.js">
